...
export const getAllTasksOfUser = async (req,res,next) => {
    try{
        ...
        res.status(200).json({message: "Fetched the tasks successfully", filteredTasks});
    }
    catch(error)
    {
        next(error);
...
export const updateTask = async (req, res, next) => {
    try{
        ...
        res.status(200).json({message: "Task updated successfully", modifiedTask});
    }
    catch(error)
    {
        next(error);
...
export const deleteTask = async (req,res,next)=> {
    try{
        ...
        res.status(200).json({message: "Task deleted successfully", nowDeletedTask});
    }
    catch(error)
    {
        next(error);
